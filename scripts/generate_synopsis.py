...
def content(document):
    ...
    bullet(document, "index.html - main application shell and views")
    bullet(document, "styles.css - visual design and responsive theme")
    bullet(document, "app.js - quiz logic, analytics, role management, and chart rendering")
    bullet(document, "project-motive.html - project motive and IoT-based positioning")
    bullet(document, "iot-architecture.html - software-only IoT architecture explanation")
